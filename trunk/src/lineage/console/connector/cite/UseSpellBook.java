...
public class UseSpellBook implements UniversalUseItem {
	...
	private void SpellBook(final L1PcInstance pc, final L1ItemInstance item, final boolean isLawful) {
		...
		final S_SkillSound s_skillSound = new S_SkillSound(objid, isLawful ? 224 : 231);

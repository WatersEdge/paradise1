...
public class LogRecorder {
	...
	public static void writeTradeLog(final L1PcInstance sender, final L1PcInstance receiver, final L1ItemInstance l1iteminstance1) {
		try {
			...
			out.write("\r\n");// 每次填写资料都控一行
			out.write("来自帐号: " + sender.getAccountName() + ", 来自玩家: " + sender.getName() + ",将  +" + l1iteminstance1.getEnchantLevel() + l1iteminstance1.getName() + "(" + l1iteminstance1.getCount() + "个)," + "交易给 " + " 帐号:" + receiver.getAccountName() + "的 " + receiver.getName()
					+ " 玩家。" + "\r\n");
			out.close();
		}
		catch (final IOException e) {

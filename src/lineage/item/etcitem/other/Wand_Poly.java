...
public class Wand_Poly extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if ((pc.getMapId() == 63) || (pc.getMapId() == 552) || (pc.getMapId() == 555) || (pc.getMapId() == 557) || (pc.getMapId() == 558) || (pc.getMapId() == 779)) { // 水中无法使用
	...
	private void polyAction(final L1PcInstance attacker, final L1Character cha) {
		...
		if (cha instanceof L1PcInstance) {
			...
			if (pc.getInventory().checkEquipped(20281)) { // 装备变形控制戒指
				...
				final L1Skills skillTemp = SkillsTable.getInstance().getTemplate(SHAPE_CHANGE);

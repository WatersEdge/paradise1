...
public class ItemClass {
	...
	public void addList(final int itemid, final String className, final int mode) {
		...
		try {
			...
			switch (mode) {
				case 0: // 道具
					stringBuilder.append("l1j.server.server.model.item.etcitem.");
					break;

				case 1: // 武器
					stringBuilder.append("l1j.server.server.model.item.weapon.");
					break;

				case 2: // 防具
					stringBuilder.append("l1j.server.server.model.item.armor.");
					break;
			}

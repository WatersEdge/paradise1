...
public class L1DollInstance extends L1NpcInstance {
	...
	public boolean noTarget() {
		if ((this._master != null) && !this._master.isDead() && (this._master.getMapId() == this.getMapId())) {
	...
	private void dollAction() {
		...
		if (this.run <= 10) {
			...
			this.setSleepTime(this.calcSleepTime(SprTable.getInstance().getSprSpeed(this.getTempCharGfx(), actionCode), MOVE_SPEED)); //
		}
	}
}

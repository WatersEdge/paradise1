...
public class C_NPCAction extends ClientBasePacket {
	...
	public C_NPCAction(byte abyte0[], ClientThread client) throws Exception {
		...
		// 租房间
			...
			/*if (pc.getPetList().isEmpty()) {
				pc.sendPackets(new S_PetCtrlMenu(pc, null, false));// 关闭宠物控制图形介面
			} else {
				// 更新宠物控制介面
				for (L1NpcInstance petNpc : pc.getPetList().values()) {
		...
		// 火焰之影的铁匠
			...
			if (s.equalsIgnoreCase("a")) {
				...
				int[] aliceMaterialIdList =
				{ 40991, 196, 197, 198, 199, 200, 201, 202 };
				int[] karmaLevelList =
				{ -1, -2, -3, -4, -5, -6, -7, -8 };
				int[][] materialsList = {
						{ 40995, 40718, 40991 },
		...
		// 炎魔的铁匠
			...
			String[] htmlIdList = {
					"lsmitha", "lsmithb", "lsmithc", "lsmithd",
			...
			int[] createItemList = {
					20083, 20131, 20069, 20179,
					20209, 20290, 20261, 20031
					};
			String[] failureHtmlIdList = {
					"lsmithaa", "lsmithbb", "lsmithcc", "lsmithdd",
		...
		// 亚塔路帝
			...
			if (s.equalsIgnoreCase("request las history book")) {
				materials = new int[] {
						41019, 41020, 41021, 41022, // 拉斯塔巴德历史书1-4
	...
	private void summonMonster(L1PcInstance pc, String s) {
		...
		summonid_list = new int[] {
				81210, 81211, 81212, // 哈柏哥布林`艾多伦`安普
	...
	private String getYaheeAmulet(L1PcInstance pc, L1NpcInstance npc, String s) {
		int[] amuletIdList = {
				20358, 20359, 20360, 20361, // 奴隶项链`约定项链`解放项链`猎犬项链
	...
	private String getBarlogEarring(L1PcInstance pc, L1NpcInstance npc, String s) {
		int[] earringIdList = {
				21020, 21021, 21022, 21023, // 舞动耳环`双子耳环`庆典耳环`绝顶耳环

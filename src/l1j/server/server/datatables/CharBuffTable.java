...
public class CharBuffTable {
	...
	private static final int[] buffSkill = {
		...
		EFFECT_POTION_OF_EXP_150, EFFECT_POTION_OF_EXP_175, // 神力药水
		EFFECT_POTION_OF_EXP_200, EFFECT_POTION_OF_EXP_225,
		EFFECT_POTION_OF_EXP_250, EFFECT_POTION_OF_BATTLE, // 战斗药水
		EFFECT_BLESS_OF_MAZU, // 妈祖的祝福
		EFFECT_ENCHANTING_BATTLE, EFFECT_STRENGTHENING_HP, EFFECT_STRENGTHENING_MP, // 强化战斗卷轴、体力增强卷轴、魔力增强卷轴
		COOKING_WONDER_DRUG, // 象牙塔妙药
		EFFECT_BLOODSTAIN_OF_ANTHARAS, EFFECT_BLOODSTAIN_OF_FAFURION, // 龙之血痕
